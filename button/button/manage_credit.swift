...
class manage_credit: UIViewController, UIPickerViewDelegate, UIPickerViewDataSource {
  ...
  override func viewDidLoad() {
    ...
    let doneButton1   = UIBarButtonItem(title: "Done", style: UIBarButtonItemStyle.done, target: self, action: #selector(manage_credit.donePressed))
    ...
    let doneButton2   = UIBarButtonItem(title: "Done", style: UIBarButtonItemStyle.done, target: self, action: #selector(manage_credit.donePressed))
    ...
    let doneButton3   = UIBarButtonItem(title: "Done", style: UIBarButtonItemStyle.done, target: self, action: #selector(manage_credit.donePressed))
